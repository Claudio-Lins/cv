...
export function UpdateWorkExperienceForm({ workExperience }: WorkExperienceProps) {
		...
		<form className='flex w-full flex-col gap-4 py-4'>
			...
			<div className='w-full flex items-center justify-between gap-4'>
				<div className='flex flex-col space-y-1.5 w-full'>
					...
					/>
					{errors?.startDate && (
						<span className={cn('text-xs font-semibold text-red-600 -mt-2')}>{errors?.startDate.message}</span>
					)}
				</div>
				<div className='flex flex-col space-y-1.5 w-full'>
					...
					/>
					{errors?.endDate && (
						<span className={cn('text-xs font-semibold text-red-600 -mt-2')}>{errors?.endDate.message}</span>
					)}
				</div>
			</div>
			<div className='w-full flex items-center justify-between gap-4'>
