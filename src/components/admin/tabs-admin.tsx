...
TabsAdminProps) {
	...
	return (
		<Tabs defaultValue={defaultTab} className='w-full'>
			...
			<TabsContent value='skills' className='p-4 flex flex-wrap gap-4 justify-center w-full'>
				{skills.map((skill) => {
			...
			<TabsContent value='work-experience' className='p-4 flex flex-wrap gap-4 justify-center w-full'>
				{workExperiences.map((workExperience) => {
					return <WorkExperience key={workExperience.id} workExperience={workExperience} />
				})}
			</TabsContent>
			<div className='flex items-center h-dvh justify-center w-full'>
